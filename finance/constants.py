...
PAYMENT_PLATFORM_TRON = 'tron'
PAYMENT_PLATFORM_BANK = 'bank'
PAYMENT_PLATFORM_TRUSTWALLET = 'trustwallet'
PAYMENT_PLATFORM_BANK = 'bank'
PAYMENT_PLATFORM_BITWAGE = 'bitwage'
PAYMENT_PLATFORM_COPPERX = 'copperx'
PAYMENT_PLATFORM_Card = 'card'
...
PAYMENT_PLATFORMS = [
    ...
    (PAYMENT_PLATFORM_BINANCE, 'Binance'),
    (PAYMENT_PLATFORM_METAMASK, 'MetaMask'),
    (PAYMENT_PLATFORM_TRON, 'TronLink'),
    (PAYMENT_PLATFORM_TRUSTWALLET, 'Trustwallet'),
    (PAYMENT_PLATFORM_BANK, 'Bank'),
    (PAYMENT_PLATFORM_BITWAGE, 'Bitwage'),
    (PAYMENT_PLATFORM_COPPERX, 'Copperx'),
